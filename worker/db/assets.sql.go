...
func (q *Queries) GetRandomAlbumAssetForCover(ctx context.Context, albumID pgtype.UUID) (Asset, error) {
	row := q.db.QueryRow(ctx, getRandomAlbumAssetForCover, albumID)
	var i Asset
	err := row.Scan(
		&i.ID,
		&i.AlbumID,
